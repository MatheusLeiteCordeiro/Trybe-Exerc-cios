...
const despesas = [
  ...
  const unravelingMapFunction = despesas.map((item) => Object.values(item));
  const unravelingReduceFunction = unravelingMapFunction.reduce((acc, curr) => curr + acc);

  console.log(unravelingReduceFunction);
//   console.log(unravelingMapFunction);
